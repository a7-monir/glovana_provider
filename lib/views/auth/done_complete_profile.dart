...
class DoneCompleteProfileView extends StatefulWidget {
  ...
  @override
  State<DoneCompleteProfileView> createState() =>
      _DoneCompleteProfileViewState();
}
            ...
            if (CacheHelper.activate == 2) ...[
              ...
              Padding(
                ...
                child: Column(
                  ...
                  children: [
                    Text(
                      LocaleKeys.yourApplicationIsBeingProcessed.tr(),
                      textAlign: TextAlign.center,
                      style: TextStyle(
                        fontSize: 25.sp,
                        fontWeight: FontWeight.w400,
