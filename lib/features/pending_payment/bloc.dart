...
class GetPendingPaymentBloc
    extends Bloc<GetPendingPaymentEvents, GetPendingPaymentStates> {
  ...
  void _getData(
    GetPendingPaymentEvent event,
    Emitter<GetPendingPaymentStates> emit,
  ) async {
