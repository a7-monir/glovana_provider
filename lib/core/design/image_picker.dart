            ...
            CupertinoButton(
              child: Row(
                children: <Widget>[
                  ...
                  const SizedBox(width: 20),
                  Text(LocaleKeys.gallery.tr(), style: TextStyle()),
                ],
              ),
              onPressed: () async {
                XFile? pickedFile = await pick.pickImage(
                            ...
                            children: [
                              ...List.generate(items.length, (index) {
                                return SelectionItem(
                                  ...
                                  isSelect: items[index] == selecteItem,
      ...
      builder: (BuildContext context) {
        return BottomSheet(
          ...
          builder: (context) {
            return Container(
              constraints: BoxConstraints(
                maxHeight: MediaQuery.of(context).size.height - 350.h,
                minHeight: 100.h,
              ),
              width: MediaQuery.of(context).size.width,
