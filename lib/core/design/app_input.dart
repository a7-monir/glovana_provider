...
class AppInput extends StatefulWidget {
  ...
  final bool isDense, isPassword, isCardNumber, isCenterTitle, isValid, isChat;
  final int maxLines;
  final int? maxLength;
...
class ChatInputFormatter extends TextInputFormatter {
  ...
  TextEditingValue formatEditUpdate(TextEditingValue oldValue, TextEditingValue newValue) {
    ...
    if (_phoneRegex.hasMatch(cleanedText)) {
      return oldValue;
    }
    if (_linkRegex.hasMatch(cleanedText)) {
      return oldValue;
    }
    return newValue;
  }
